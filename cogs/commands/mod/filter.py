...
class Filters(commands.Cog):
    ...
    @transform_context
    @always_whisper
    async def offlineping(self, ctx: ImperialContext, val: bool = None):
    ...
    @transform_context
    async def add(self, ctx: ImperialContext, notify: bool, bypass: int, phrase: str) -> None:
        fw = FilterWord()
        fw.bypass = bypass
        fw.notify = notify
        fw.word = phrase
    ...
    @transform_context
    async def _list(self, ctx: ImperialContext):
    ...
    @transform_context
    async def piracy(self, ctx: ImperialContext, word: str):
        word = word.lower()
    ...
    @app_commands.autocomplete(word=filterwords_autocomplete)
    @transform_context
    async def remove(self, ctx: ImperialContext, word: str):
        word = word.lower()
    ...
    @transform_context
    async def whitelist(self, ctx: ImperialContext, guild_id: str):
        try:
    ...
    @transform_context
    async def blacklist(self, ctx: ImperialContext, guild_id: str):
        try:
            guild_id = int(guild_id)
        except ValueError:
            raise commands.BadArgument("Invalid ID!")
    ...
    @transform_context
    async def ignorechannel(self, ctx: ImperialContext, channel: discord.TextChannel) -> None:
    ...
    @transform_context
    async def unignorechannel(self, ctx: ImperialContext, channel: discord.TextChannel) -> None:
    ...
    @app_commands.describe(channel="Channel to ignore")
    @transform_context
    async def ignorechannellogs(self, ctx: ImperialContext, channel: discord.TextChannel) -> None:
    ...
    @app_commands.describe(channel="Channel to unignore")
    @transform_context
    async def unignorechannellogs(self, ctx: ImperialContext, channel: discord.TextChannel) -> None:
    ...
    @app_commands.autocomplete(word=filterwords_autocomplete)
    @transform_context
    async def falsepositive(self, ctx: ImperialContext, *, word: str):
        word = word.lower()
