...
from utils import ImperialContext, cfg, end_giveaway, transform_context
...
class Giveaway(commands.Cog):
    ...
    @transform_context
    async def start(self, ctx: ImperialContext, prize: str, sponsor: discord.Member, time: Duration, winners: int, channel: discord.TextChannel):
        delta = time
        if delta is None:
    ...
    @transform_context
    async def reroll(self, ctx: ImperialContext, message_id: str):
    ...
    @app_commands.describe(message_id="The ID of the giveaway message.")
    @transform_context
    async def end(self, ctx: ImperialContext, message_id: str):
