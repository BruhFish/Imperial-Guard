...
from utils import ImperialContext, cfg, transform_context, format_number
...
class Stats(commands.Cog):
    ...
    @transform_context
    @whisper
    async def ping(self, ctx: ImperialContext) -> None:
        embed = discord.Embed(
    ...
    @transform_context
    @whisper
    async def roleinfo(self, ctx: ImperialContext, role: discord.Role) -> None:
    ...
    @transform_context
    @whisper
    async def stats(self, ctx: ImperialContext) -> None:
    ...
    @transform_context
    @whisper
    async def serverinfo(self, ctx: ImperialContext):
        guild = ctx.guild
    ...
    @transform_context
    @whisper
    async def raidstats(self, ctx: ImperialContext) -> None:
    ...
    @transform_context
    @whisper
    async def mod(self, ctx: ImperialContext, mod: discord.Member = None, keyword: str = None) -> None:
        if mod is None:
            mod = ctx.author
    ...
    @transform_context
    @whisper
    async def keyword(self, ctx: ImperialContext, keyword: str) -> None:
        embed = discord.Embed(color=discord.Color.blurple())
