...
class Utilities(commands.Cog):
    ...
    @transform_context
    async def help(self, ctx: ImperialContext, *, command_name: str = None) -> None:
    ...
    @transform_context
    @whisper
    async def usage(self, ctx: ImperialContext, command_name: str):
    ...
    async def get_usage_embed(self,  ctx: ImperialContext, command: app_commands.Command) -> discord.Embed:
